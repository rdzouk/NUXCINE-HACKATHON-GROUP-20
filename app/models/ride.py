...
class RideEvent(Base):
    ...
    # An IDENTITY column, generated by Postgres. The Identity() marker is what
    # tells SQLAlchemy to leave it out of the INSERT entirely; without it the
    # ORM sends an explicit NULL and the not-null constraint rejects the row.
